...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm', array(
	...
	<div class="control-group">
		...
		<div class="controls">
			...
			$this->widget('zii.widgets.jui.CJuiAutoComplete', array(
				...
				'htmlOptions'=>array('class'=>'span6','placeholder'=>'Buscar nombre de bien...'),  
				'options'=>array(
					'showAnim'=>'fold',
	...
	<div class="control-group">
        ...
        <div class="control-group">
		<label id="control-label" class="control-label">Precio:</label>
		<div class="controls">
			<?php echo $form->textField($model,'BIE_precio'); ?>
		</div>
	</div>
