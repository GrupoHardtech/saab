...
$this->widget('bootstrap.widgets.TbGridView',array(
  ...
  'template'=>"{items}",
  'columns'=>array(
    array('name'=>'id', 'header'=>'Código','htmlOptions'=>array('style' => 'width:44px')),
    array('name'=>'bien', 'header'=>'Bien','htmlOptions'=>array('style' => 'width:580px')),
    array('name'=>'unidad', 'header'=>'Unidad','htmlOptions'=>array('style' => 'width:214px')),
    array('name'=>'cantidad', 'header'=>'Cantidad','htmlOptions'=>array('style' => 'width:46px')),
    array(
      'class'=>'CButtonColumn',
      'header' => 'Opciones',
